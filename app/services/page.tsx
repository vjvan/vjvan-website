...
const services = [
  ...
  },
  {
    title: "AI 影片製作",
    description:
      "用 Remotion 程式化生成行銷影片，一句話就能產出品牌動畫、產品介紹、數據報告影片。",
    features: [
      "程式化行銷影片生成",
      "品牌形象動畫製作",
      "數據驅動的報告影片",
...
const faqs = [
  {
    ...
    answer:
      "核心系統（LIFF + 管理後台 + 自動化通知）約 NT$150,000-200,000，完整系統（含行銷整合、進階分析）約 NT$200,000-250,000。實際費用依功能範圍而定，歡迎聯繫討論。",
  },
  {
    question: "開發需要多久？",
    answer:
  ...
  },
  {
    question: "系統上線後誰來維護？",
    answer:
      "提供月維護方案（NT$3,500-6,000/月），包含系統監控、Bug 修復、功能微調。緊急故障保證 4 小時內回應。",
  },
];
